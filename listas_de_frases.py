...
buenos_dias = ["Despertar es dejar de dormir, no dejar de soñar. ¡Buenos días!”, "La vida se prepara con amor, se condimenta con fe, y se vive con agradecimiento. ¡Buenos días!",
                "Un buen día comienza con una buena actitud y taza de café.", "La vida siempre te ofrece otra oportunidad y se llama 'HOY'. ¡Buenos días!",
...
lista funciones= ["Puedo darte la fecha", "La hora", "Lo que hace la aplicación 2","Lo que hace la aplicación 3", "Si tienes alguna emergencia, puedo contactar a un familiar, solo tienes que pedirme ayuda", "puedo recordarte las funciones que tengo",
                  "Y recuerda, que, si necesitas algo, no tienes más que decir mi nombre y escuchare tu orden", "Y si no me necesitas, solo debemos despedirnos y descansare hasta me necesites"]


accioness = """ Darte la hora, 
                la fecha,  
                Si necesitas ayuda, solo debes avisarme y pediré ayuda por ti,
                ...
                """
sugerencia = """ Antes de empezar, te sugiero que tengas a mano un lápiz y un cuaderno, y cuando estes listo, ¡solo di LISTO!"""
# ------------------------- frases orden alfabético -----------------------
...
Estas palabras, deberás ordenarlas alfabéticamente. Por ejemplo: si el campo seleccionado es el mar, las palabras pueden ser, estrella, arena y delfín, y el 
orden correcto sería arena, delfín y estrella, ya que primero está la a, de arena, luego d de delfín y luego e de estrella."""
